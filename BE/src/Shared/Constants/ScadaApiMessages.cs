...
public static class ScadaApiMessages
{
    ...
    public const string StationActiveAlarmsOk = "Alarm đang mở theo trạm (Redis realtime).";
    public const string StationTeamOk = "Tổ vận hành theo trạm (Redis realtime).";
